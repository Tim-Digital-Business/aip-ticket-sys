    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
      <div class="container">
        <div class="navbar-brand">
          ...
          <span class="animate__animated animate__slideInDown navbar-caption-wrap"><a class="navbar-caption text-white display-7" href="https://www.aip.swiss">AIP Plus
              Pratteln</a></span>
        </div>
            ...
            <div id="bootstrap-toggle" class="toggle-panel accordionStyles tab-content">
              ...
              <div class="card mb-3">
                ...
                <div id="collapse2_2" class="panel-collapse noScroll collapse" role="tabpanel" aria-labelledby="headingTwo">
                  <div class="panel-body">
                    <p style='text-shadow: 0 0 3px #000000;background-color: #00000075;border-radius: 10px;padding-left: 10px;' class="text-white mbr-fonts-style panel-text display-7">Wir werden dich so
