...
<body>
    ...
    <body>
        ...
        <main role="main" class="container">
            ...
            <button type="button" class="btn btn-info" onclick="window.location.href = 'login/Welcome.php';">Login for
                Admins</button> -->
        ...
        <footer role="footer" class="footer mt-auto py-3 bg-light text-center text-lg-start">
            <!-- Copyright -->
