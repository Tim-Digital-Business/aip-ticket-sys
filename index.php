...
<body>
        ...
        <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
            <div class="container">
                <div class="navbar-brand">
                    ...
                    <span class="animate__animated animate__slideInDown navbar-caption-wrap"><a
                            class="navbar-caption text-white display-7" href="https://www.aip.swiss">AIP Plus
                            Pratteln</a></span>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                        <li class="nav-item"><a
                                class="animate__animated animate__slideInDown nav-link link text-white display-4"
                                href="../auth/login.php">Admin</a></li>
                    </ul>
                </div>
            </div>
        </nav>
    ...
    <section data-bs-version="5.1" class="header13 cid-sRc7vFQ6FN mbr-fullscreen mbr-parallax-background"
        id="header13-l">
        <div class="align-center container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10">
                    <h1 style='text-shadow: 0 0 3px #000000 ; font-family:sans-serif'
                        class="animate__animated animate__slideInLeft text-white mbr-section-title mbr-fonts-style mb-3 display-1">
                        <strong>Digital Business</strong>
                    </h1>
                    <button class="button-28 animate__animated animate__fadeInBottomLeft" data-toggle="modal"
                        data-target="#modalCreateTicket" type="button">Ticket erfassen</button>
                </div>
            </div>
        </div>


        <section data-bs-version="5.1" class="animate__animated animate__slideInRight content17 cid-sRc7CKH74t"
            id="content17-n">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10">
                        <div class="section-head align-center mb-4">
                            <h3 style='text-shadow: 0 0 3px #000000;padding-right:300px'
                                class="text-white mbr-section-title mb-0 mbr-fonts-style display-2"><strong>FAQ</strong>
                            </h3>
                        </div>
                        ...
                        <div id="bootstrap-toggle" class="toggle-panel accordionStyles tab-content">
                            <div class="card mb-3">
                                <div class="card-header" role="tab" id="headingOne">
                                    <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                        data-bs-toggle="collapse" data-core="" href="#collapse1_2" aria-expanded="true"
                                ...
                                <div id="collapse1_2" class="panel-collapse noScroll collapse" role="tabpanel"
                            ...
                            <div class="card mb-3">
                                <div class="card-header" role="tab" id="headingTwo">
                                    <a role="button" class="collapsed panel-title text-black" data-toggle="collapse"
                                        data-bs-toggle="collapse" data-core="" href="#collapse2_2" aria-expanded="false"
                                ...
                                <div id="collapse2_2" class="panel-collapse noScroll collapse" role="tabpanel"
                                    aria-labelledby="headingTwo">
                                    <div class="panel-body">
                                        <p style='text-shadow: 0 0 3px #000000;background-color: #00000075;border-radius: 10px;padding-left: 10px;'
                                            class="text-white mbr-fonts-style panel-text display-7">Wir werden dich so
                                            schnell wie möglich Kontaktieren und eine Lösung für dein Problem finden.
                                            Gerne kannst du auch in unsere Abteilung vorbeischauen.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="card mb-3">
